"""
LifeSphere Backend — Email Service
...
logger = logging.getLogger("lifesphere.email")
...
def send_verification_email(recipient_email: str, code: str) -> bool:
    ...
    try:
        ...
        msg.set_content(
            f"Hello,\n\n"
            f"You requested to reset your password for LifeSphere.\n\n"
            f"Your verification code is: {code}\n\n"
            f"This code will expire in 15 minutes.\n\n"
            f"If you did not request this, please ignore this email."
        )
        msg["Subject"] = "LifeSphere - Your Password Reset Code"
        msg["From"] = f"LifeSphere <{settings.SMTP_EMAIL}>"
...
def send_admin_reset_password_email(recipient_email: str, new_password: str) -> bool:
    ...
    try:
        ...
        msg.set_content(
            f"Hello,\n\n"
            f"An administrator has reset your password for LifeSphere.\n\n"
            f"Your new password is: {new_password}\n\n"
            f"Please log in and change your password immediately."
        )
        msg["Subject"] = "LifeSphere - Administrator Password Reset"
        msg["From"] = f"LifeSphere <{settings.SMTP_EMAIL}>"
        msg["To"] = recipient_email
...
def send_login_alert_email(recipient_email: str, ip_address: str, user_agent: str, time_str: str) -> bool:
    ...
    try:
        ...
        msg.set_content(
            f"Hello,\n\n"
            f"We noticed a new login to your LifeSphere account.\n\n"
            f"Time: {time_str}\n"
        ...
        <body style="margin: 0; padding: 0; background-color: #f8fafc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
          <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05); border: 1px solid #e2e8f0;">
            ...
            <div style="padding: 40px 32px;">
              <p style="font-size: 16px; color: #475569; margin-top: 0;">We noticed a new login to your LifeSphere account.</p>
        ...
        msg["Subject"] = "LifeSphere - New Login Detected"
        msg["From"] = f"LifeSphere Security <{settings.SMTP_EMAIL}>"
        msg["To"] = recipient_email
...
def send_sos_email(recipient_emails: List[str], user_name: str, location_url: Optional[str] = None) -> bool:
    ...
    try:
        ...
        text_content = (
            f"🚨 EMERGENCY ALERT 🚨\n\n"
            f"{user_name} has triggered an SOS emergency alert via LifeSphere.\n\n"
          ...
          <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(220, 38, 38, 0.15); border: 2px solid #ef4444;">
            ...
            <div style="padding: 40px 32px;">
              ...
              <div style="background-color: #fef2f2; border-left: 4px solid #ef4444; padding: 20px; border-radius: 0 8px 8px 0; margin: 24px 0;">
                <p style="margin: 0; font-size: 18px; color: #7f1d1d;">
                  <strong style="font-size: 20px;">{user_name}</strong> has triggered an SOS emergency alert via LifeSphere.
                </p>
              </div>
            ...
            <div style="background-color: #f1f5f9; padding: 24px; text-align: center; border-top: 1px solid #e2e8f0;">
              <p style="margin: 0; font-size: 13px; color: #64748b;">
                This is an automated emergency message sent securely via the LifeSphere Emergency System.
              </p>
            </div>
        ...
        msg["From"] = f"LifeSphere Emergency System <{settings.SMTP_EMAIL}>"
...
def send_organ_match_email(recipient_email: str, recipient_name: str, requester_name: str, organ: str, emergency_contact: str = None) -> bool:
    ...
    try:
        ...
        msg.set_content(
            ...
            f"Please log in to your LifeSphere account to review the request and contact your primary healthcare provider.\n"
        ...
        msg["Subject"] = f"LifeSphere - Organ Match Request Initiated: {organ}"
        msg["From"] = f"LifeSphere Network <{settings.SMTP_EMAIL}>"
        msg["To"] = recipient_email
