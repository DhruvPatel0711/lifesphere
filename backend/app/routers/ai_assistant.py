"""
LifeSphere Backend — AI Chat Doctor Router
"""
...
async def public_chat(data: ChatMessageCreate):
    ...
    context = "This is a prospective user on the LifeSphere landing page. Be highly welcoming, explain features briefly, and encourage them to sign up. Do not provide specific medical advice without a disclaimer."
