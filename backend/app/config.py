"""
LifeSphere Backend — Application Configuration
...
class Settings(BaseSettings):
    ...
    # --- Application ---
    APP_NAME: str = "LifeSphere"
    APP_VERSION: str = "1.0.0"
    DEBUG: bool = False
    LOG_LEVEL: str = "INFO"

    # --- Database ---
    DATABASE_URL: str = "postgresql+asyncpg://postgres:xxxx@localhost:xxxx/lifesphere_db"
