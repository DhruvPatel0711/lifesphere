...
const Emergency = ({ voiceAction, onVoiceActionConsumed }) => {
  ...
  const downloadQR = async () => {
    try {
      ...
      a.href = url;
      a.download = 'LifeSphere_Emergency_QR.png';
                ...
                {getNearbyHospitals().map((h, i) => (
                  <div key={i} className={`flex items-center justify-between p-4 transition-colors hover:bg-red-50 dark:hover:bg-red-900/10 cursor-pointer ${i !== getNearbyHospitals().length - 1 ? 'border-b border-gray-50 dark:border-gray-700/50' : ''}`}>
                    ...
                    <div className="flex items-center gap-2">
                      <a href={`tel:${h.phone}`} className="px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-semibold text-sm hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors flex items-center gap-1.5">
                        <Phone size={14} /> Call
                      </a>
                      <a
                        ...
                        className="px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 font-semibold text-sm hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors flex items-center gap-1.5"
                      >
              ...
              <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-900 p-8 shadow-2xl border border-white/10 group">
                ...
                <div className="relative z-10 flex justify-between items-start mb-10 border-b border-white/10 pb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-black text-white tracking-tight">LifeSphere Health ID</h3>
                ...
                <div className="relative z-10 flex flex-col items-start w-full">
                  ...
                  <div className="w-full text-left mb-6">
                    ...
                    <div className="font-black text-white text-3xl truncate leading-tight">{profile?.name || "LifeSphere User"}</div>
                  </div>
