          ...
          <div className="modal">
            ...
            <div className="modal-body" style={{ textAlign: 'center', padding: '32px 20px 20px 20px' }}>
              ...
              <p style={{ color: '#475569', fontSize: '0.9rem', marginBottom: '32px', maxWidth: '90%', margin: '0 auto 32px auto', lineHeight: '1.5' }}>
                Upload a medical report (PDF, PNG, JPG, WEBP, or TXT). Our AI will automatically extract key health metrics, doctor details, and clinical findings.
              </p>
              <div style={{ border: '1px dashed #cbd5e1', borderRadius: '16px', padding: '40px 20px', cursor: 'pointer', transition: 'all 0.3s', background: '#F8FAFC', textAlign: 'center' }}
                ...
                <p style={{ fontSize: '0.85rem', color: '#475569' }}>PDF, PNG, JPG, WEBP, TXT files · Max 10MB</p>
              </div>
              <input type="file" id="ai-report-file" accept=".pdf,.png,.jpg,.jpeg,.webp,.txt" style={{ display: 'none' }} onChange={async (e) => {
