...
const LandingChatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', content: "Hi! I'm the LifeSphere AI assistant demo. Try asking about sleep, symptoms, or what LifeSphere can track." }
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reply = res.response || res.message || res.reply;
      if (reply) {
    ...
    setTimeout(() => {
      ...
      if (lowerMsg.includes('sleep')) {
        ...
        responseText = "Hello! 👋 I am the **LifeSphere AI Assistant**. How can I help you today?";
      } else if (lowerMsg.includes('who are you') || lowerMsg.includes('what are you')) {
        responseText = "I am the **LifeSphere AI Assistant**. I'm here to help you track your health metrics, provide wellness tips, and make managing your health journey as seamless as possible!";
      } else {
        responseText = `I understand your query regarding '${userMessage}'. Always consult your doctor for formal diagnosis. I am here to assist with vitals, nutrition, and symptom checking.`;
      }
      ...
      >
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 px-5 py-4 flex items-center justify-between text-white">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="font-bold text-sm leading-tight">LifeSphere AI Assistant</div>
              <div className="text-[11px] opacity-80 leading-tight">AI Assistant · Speak or type</div>
            </div>
          </div>
              ...
              <div className="relative group">
                ...
                {msg.role === 'assistant' && (
                  <button
                    ...
                    className="mt-1 text-[11px] text-blue-500 hover:text-blue-600 flex items-center gap-1 font-semibold border-none bg-transparent cursor-pointer"
                  >
                    <span className="material-symbols-outlined text-[14px]">volume_up</span> Listen
                  </button>
                )}
              </div>
            </div>
        ...
        <div className="flex gap-2 flex-wrap px-4 pb-2">
          ...
          <button onClick={() => {setInput('What does LifeSphere track?');}} className="text-[11px] font-semibold bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 px-3 py-1.5 rounded-full hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-colors border-none cursor-pointer">What it tracks</button>
