...
const LoginModal = ({ show, onClose }) => {
  ...
  // Login form
  const [email, setEmail] = useState('gaurav@lifesphere.com');
  ...
  const switchToSignUp = (e) => {
    e.preventDefault();
    setError('');
    if (email === 'gaurav@lifesphere.com') {
      setEmail('');
      setPassword('');
    }
    setMode('signup');
  ...
  const switchToForgot = (e) => {
    e.preventDefault();
    setError('');
    if (email && email !== 'gaurav@lifesphere.com') {
  ...
  const titles = {
    login: { title: 'Welcome Back', subtitle: 'Sign in to your LifeSphere health portal' },
    signup: { title: 'Create Account', subtitle: 'Join LifeSphere to optimize your health' },
