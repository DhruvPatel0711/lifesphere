# LifeSphere Backend — AI-Powered Healthcare Operating System

A production-ready **FastAPI** backend for the LifeSphere frontend, providing 80+ REST API endpoints across 16 healthcare modules.
...
curl -X POST http://localhost:8000/api/v1/auth/register \
  ...
  -d '{"email":"test@lifesphere.com","password":"Test123!","name":"Test User"}'

# Login
curl -X POST http://localhost:8000/api/v1/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"gaurav@lifesphere.com","password":"password123"}'
...
| Email | Password | Role |
|-------|----------|------|
| gaurav@lifesphere.com | password123 | patient |
