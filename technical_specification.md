# LifeSphere - Technical Specification
...
### Deployment
1. **Docker**: `docker-compose.yml` configures a Postgres DB (`lifesphere_db`), FastAPI app (`lifesphere_app`), and a separate Flask Chatbot app (`lifesphere_chatbot`).
