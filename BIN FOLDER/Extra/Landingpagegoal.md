...
I have an existing multi-section **React + Vite landing page** for a healthcare platform called **LifeSphere**.
...
Keep the existing LifeSphere branding and dashboard content.
...
Preserve its current functionality and LifeSphere logo.
